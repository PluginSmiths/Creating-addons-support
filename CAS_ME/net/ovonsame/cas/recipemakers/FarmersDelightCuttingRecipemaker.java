...
public class FarmersDelightCuttingRecipemaker extends JPanel{
    ...
    public FarmersDelightCuttingRecipemaker(MCreator mcreator, MCItem.ListProvider itemsWithTags, MCItem.ListProvider items) {
        ImagePanel ip = new ImagePanel(UIRES.get("recipe.cutting_board").getImage());
        ...
        cb1.setBounds(112, 48, 32, 32);
        cb2.setBounds(112, 176, 32, 32);
